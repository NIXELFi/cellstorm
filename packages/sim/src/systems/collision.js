 ...
 */
export function collisionSystem(w, sink) {
                ...
                for (const j of list) {
                    ...
                    if (d2 < sumR * sumR && d2 > 0.01) {
                        ...
                        if (c.team !== o.team) {
                            ...
                            let baseC = 1.4;
                            let baseO = 1.4;
                            if (pC.charge && c.dash > 0)
                                baseC = pC.chargeBurst;
                            if (pO.charge && o.dash > 0)
                                baseO = pO.chargeBurst;
                            c.vx -= nx * 0.4;
                            c.vy -= ny * 0.4;
                            o.vx += nx * 0.4;
                            o.vy += ny * 0.4;
